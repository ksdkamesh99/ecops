...
<body>
  ...
  <div class="dropdown">
	...
	<div id="ma" style="display: inline-block;position: relative;left: 10px;bottom: 0px;">
	  	<h2 ><span style="background-color: #fc720f">Police Medals</span></h2>
    	
    	<figure id="img1">
    	<img src="police medals/persidential.jpeg" width="200" height="250" alt="img"><br>
    	<caption> 
    		
    		President's Police Medal<br> for Distinguished Servic
    	<br>
    	...
    	<figure id="img2">
    	<img src="police medals/gallentry.jpeg" width="200" height="250" alt="img"><br>
    	<caption> President's Police Medal
    	<br>for Galllantry
    ...
    <figure id="img3">
    	<img src="police medals/indepandance.jpeg" width="200" height="250" alt="img"><br>
    	<caption> 
    	India Indepandance <br>
    	police madel
    	</caption>
    	</figure>

    	<figure id="img4">
    	<img src="police medals/param.jpeg" width="200" height="250" alt="img"><br>
    	<caption> 
    	Param Vishisht Seva<br>
    	Medal
    	</caption>
    	</figure>

    	<figure id="img5">
    	<img src="police medals/Ribbon Samanya Seva medal.jpeg" width="200" height="250" alt="img"><br>
    	<caption> 
    	Ribbon Samanyan Seva<br>
    	Medal
    	</caption>
    	</figure>
	...
	<div style="margin: 0px auto;padding: 20px;position:relative;left:1200px; ">
		<img src="car.gif" width="250px" height="100px" >
	</div>
