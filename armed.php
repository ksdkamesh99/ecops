...
$mess="Hi There,Thanks FOr Choosing Ecops,your Application For Armed License is successfully received.It is in Process";
$pho=$_POST['phone'];
...
require("PHPMailer/src/PHPMailer.php");
 ...
 // debugging: 1 = errors and messages, 2 = messages only
    ...
    $mail->Subject = "Armed License Form Confirmation";
    $mail->Body = "Hello  ".$name."<br><br>Thanks FOr Choosing Ecops,your Application For Armed License is successfully received.It is in Process<br>For any Other Queries Feel Free To Contact Us<br><br>With Regards,<br>Ecops<br>
