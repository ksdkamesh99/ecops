...
<body>
	...
	<div id="qqq">
		...
		<form>
		 <p style="padding-right: 20px;display: inline-block;">Select The State :</p><select>
		 	<option>-----------------</option>
		 ...
		 <p style="padding-right: 20px;display: inline-block;">Enter The area :</p><input type="text" name="n"><br>
		 <p style="padding-right: 20px;display: inline-block;">Enter  The age :</p><input type="number" name="n1"><br>
