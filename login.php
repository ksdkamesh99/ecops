...
<form  method="POST" name="f1" action="loginprocess.php">
    ...
    <input class="input-field" type="text" placeholder="Username" name="n1">
  </div>
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="password" placeholder="Password" name="p1">
  </div>
<br><center><input type="submit" name="submit" class=" registerbtn"value="submit"/> </center>
 <br>
</form>
</fieldset>
</div>
