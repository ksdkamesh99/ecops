			...
			if(isset($_POST['sub'])){
				...
				if(mysqli_num_rows($result)>0){
					...
					while($results=mysqli_fetch_array($result)){
						...
						echo ""."Name:"."" . $results["name"] ;echo "<hr>";
						echo ""."Fir Id:"."" . $results["fir_id"] ;echo "<hr>";
                        echo "Phone:". $results["phone"] ;echo "<hr>";
                        echo "Email:". $results["email"] ;echo "<hr>";
                        echo "Address:".$results["address"] ;echo "<hr>";
                        echo "Pin Code:". $results["pincode"] ;echo "<hr>";
                        echo "City:". $results["city"] . "</td></tr>";echo "<hr>";
						echo "Date Of Occurance:". $results["dis_f"] ;echo "<hr>";
						echo "Distance From Police Station:". $results["dis_f"] ;echo "<hr>";
                        echo "Direction From Police Station:". $results["dir_f"] ;echo "<hr>";
                        echo "Date Of Occurance:". $results["date_com"] ;echo "<hr>";
                        echo "Hour Of Occurance:". $results["time_com"] ;echo "<hr>";
                        echo "Description of Accused:". $results["text_complaint_acd"] ;echo "<hr>";
                        echo "Details Of Witness:". $results["complaint_wit"] ;echo "<hr>";
