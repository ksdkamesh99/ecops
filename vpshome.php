...
<body oncontextmenu="return false;">
	...
	<div id="qqq">
		<h1 style="position: relative;left: 270px;font-family: 'Anton', sans-serif;top: 70px;"><center>Virtual Police Station</center></h1>
		
	<div id="d1"><a href="casestatus.php"><img src="case.png" width="200px" height="200px"><div id="d11" style=""><center><p id="p1" >Case Status</p></center></div></a></div>
	<div id="d2"><a href="appointingtransfer.php"><img src="aptr.jpg" width="200px" height="200px"><div id="d22" style=""><center><p id="p2">Appoint/Transfer</p></center></div></a></div>
	
	<div id="d4"><a href="areasundercontrol.php"><img src="areas.jpg" width="200px" height="200px"><div id="d44" style=""><center><p id="p4">Areas Control</p></center></div></a></div>
	<div id="d5"><a href="firwriting.php"><img src="fir.jpg" width="200px" height="200px"><div id="d55" style=""><center><p id="p5">F.I.R</p></center></div></a></div>
